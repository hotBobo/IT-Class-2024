...
def main(): #creates method outside of the Flower class called main
    ...
    flower3 = Flower("Sunflower") #creates flower3 object and assigns the name Sunflower
    flower3.grow() #runs the grow method with the name assigned to flower3
    flower3.bloom() #runs the bloom method with the name assigned to flower3
